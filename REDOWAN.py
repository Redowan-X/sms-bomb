...
r'| $$  \ $$| $$  | $$        | $$  \ $$| $$\  $ | $$| $$  \ $$',
r'| $$$$$$$/| $$$$$$$/        | $$$$$$$/| $$ \/  | $$| $$$$$$$/',
r'|_______/ |_______/         |_______/ |__/     |__/|_______/ ',
 '                                                                      ']
	for i in logo:
		print(random.choice(banner_colors),i)
	print(f'     {blue}Developer: {green}REDOWAN {white}| {blue}from: {green}Bhangladesh     ')
	print('')

def update():
	banner()
	print(blue,'SMS Bombing hoitase ektu wait kor'.center(62,' '))
	print()
...
def goodbye():
	...
	print(red,f'Failed     :  {failed}  OTP'.center(60,' '))
	print()
	print(green,'Thanks .'.center(62,' '))
	exit()


try:
	banner()
	number=str(input(f'{blue} [*] jei number a sms pathabi oi number ta de: '))
	if len(number)<11 or len(number)>11:
		print(f'\n{red} [*] Sothik number de boka')
		exit()
	try:
		amount=int(input(f'{green} [*] Koita sms pathabi lekh nare beta: '))
	except ValueError:
		print(f'\n{red} [*] Khali number de boka')
		exit()
